...
class MechanicTest {
    ...
    private fun locksWithin(sim: Simulation, ticks: Int): Boolean {
        // A piece falls under gravity from the spawn tick (ADR 0017) — there is
        // no positioning window in front of the fall — so this measures the lock
        // path from the moment the piece begins to fall.
        sim.start()
