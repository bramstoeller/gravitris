...
| 0012–0014 | *reserved on `chore/architecture` (piece-geometry, restitution, overrun) — unmerged; numbers avoided here to prevent collision (see Architect)* | |
...
| [0016](../docs/adr/0016-piece-lifecycle-and-rotation-semantics.md) | Piece lifecycle POSITIONING→FALLING; slide-while-positioning, rotate-while-falling; snap-rotate positions | Time-pressure + shapes answer "too easy". Core gates dumb intents by phase. Rotation exact `(x,y)->(y,-x)`, isotropic constraints hold the turn; positioning is gravity-suppressed (weightless), not pinned |
